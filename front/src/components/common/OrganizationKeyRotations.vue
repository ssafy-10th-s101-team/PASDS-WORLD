      ...
      <div class="flex flex-col justify-between h-full ">
        <div>
          <div class="lg:flex w-full justify-between">
            <h3 class="text-gray-600 dark:text-gray-400 leading-5 text-base md:text-xl">월별 키회전수</h3>
          ...
          <div class="flex items-end mt-6">
            <h3 v-if="selectedYear == 2024" class="text-indigo-500 leading-5 text-lg md:text-2xl">{{ graphData[graphData.length-1] }}회</h3>
        ...
        <div class="mt-6">
          <canvas id="myChart3" width="1025" height="400" role="img"
...
watch(
  ...
  () => {
    try {
      ...
      // 월
      props.organizationRotateList.forEach((data) => {
